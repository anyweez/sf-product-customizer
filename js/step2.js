...
const options = {
    none(box) {
        ...
        box.customize('top_font', null);
        box.customize('top_text', null);
    },
    ...
    quote_1(box) { 
        ...
        box.customize('top_font', 'corsiva'); // built-in quotes default to corsiva
        box.customize('top_text', quote);
    },
    quote_2(box) { 
        ...
        box.customize('top_font', 'corsiva');
        box.customize('top_text', quote);
    },
    quote_3(box) { 
